...
class FrontAddView(BaseView):  # 前台学生信息添加
    ...
    def post(self, request):
        ...
        student.studentPassword = request.POST.get('student.studentPassword')
        student.studentSex = request.POST.get('student.studentSex')
        student.studentClassNumber = ClassInfo.objects.get(classNumber=request.POST.get('student.studentClassNumber.classNumber'))
        student.studentBirthday = request.POST.get('student.studentBirthday')
        student.studentState = request.POST.get('student.studentState')
        try:
            student.studentPhoto = self.uploadImageFile(request,'student.studentPhoto')
        except ImageFormatException as ife:
            return JsonResponse({'success': False, 'message': ife.error})
        student.studentTelephone = request.POST.get('student.studentTelephone')
        student.studentEmail = request.POST.get('student.studentEmail')
        student.studentQQ = request.POST.get('student.studentQQ')
        student.studentAddress = request.POST.get('student.studentAddress')
        student.studentMemo = request.POST.get('student.studentMemo')
...
class FrontListView(BaseView):  # 前台学生信息查询列表
    ...
    def handle(self, request):
        ...
        studentClassNumber_classNumber = self.getStrParam(request, 'studentClassNumber.classNumber')
        studentBirthday = self.getStrParam(request, 'studentBirthday')
        # 然后条件组合查询过滤
        ...
        if studentClassNumber_classNumber != '':
            students = students.filter(studentClassNumber=studentClassNumber_classNumber)
        if studentBirthday != '':
            students = students.filter(studentBirthday__contains=studentBirthday)
        ...
        context = {
            ...
            'studentClassNumber_classNumber': studentClassNumber_classNumber,
...
class UpdateView(BaseView):  # Ajax方式学生信息更新
    ...
    def post(self, request, studentNumber):
        ...
        student.studentState = request.POST.get('student.studentState')
        try:
            studentPhotoName = self.uploadImageFile(request, 'student.studentPhoto')
        except ImageFormatException as ife:
            return JsonResponse({'success': False, 'message': ife.error})
        if studentPhotoName != 'img/NoImage.jpg':
            student.studentPhoto = studentPhotoName
        student.studentTelephone = request.POST.get('student.studentTelephone')
        student.studentEmail = request.POST.get('student.studentEmail')
        student.studentQQ = request.POST.get('student.studentQQ')
        student.studentAddress = request.POST.get('student.studentAddress')
